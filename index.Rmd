...
```{r}
res <- list()
res[[1]] <- data.frame(animal="Cattle", n=sum(farm_db$Cattle, na.rm=T))
res[[2]] <- data.frame(animal="Horse", n=sum(farm_db$Horse, na.rm=T))
res[[3]] <- data.frame(animal="Pig", n=sum(farm_db$Pig...46, na.rm=T))
res[[4]] <- data.frame(animal="Chicken", n=sum(farm_db$Chicken...47, na.rm=T))
