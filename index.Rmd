...
mam_cap_db$head_width<- as.numeric(mam_cap_db$head_width_neurocranium)
mam_cap_db$ear_length<- as.numeric(mam_cap_db$ear_length)
mam_cap_db$neck_circumference<- as.numeric(mam_cap_db$neck_circumference)
mam_cap_db$thorax_circum<- as.numeric(mam_cap_db$thorax_circum)
mam_cap_db$tail_length<- as.numeric(mam_cap_db$tail_length)
mam_cap_db$total_length<- as.numeric(mam_cap_db$total_length)
mam_cap_db$tarsal_length<- as.numeric(mam_cap_db$tarsal_length)
mam_cap_db$fore_paw_palm_length<- as.numeric(mam_cap_db$fore_paw_palm_length)
mam_cap_db$fore_paw_palm_width<- as.numeric(mam_cap_db$fore_paw_palm_width)
mam_cap_db$hind_paw_palm_length <- as.numeric(mam_cap_db$hind_paw_palm_length)
mam_cap_db$hind_paw_palm_width<- as.numeric(mam_cap_db$hind_paw_palm_width)
mam_cap_db$canine_length_superior<- as.numeric(mam_cap_db$canine_length_superior)
mam_cap_db$canine_length_inferior<- as.numeric(mam_cap_db$canine_length_inferior)
