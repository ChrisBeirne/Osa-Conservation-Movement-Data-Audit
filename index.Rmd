...
# The species data
# 2. https://docs.google.com/spreadsheets/d/18WlT7Loq0xBST6vR8vqt333whm6wJJBCSPyWaz5Z6M0/edit?usp=sharing 
...
```{r}
ex_check_db$current_bait_weight_kg <- as.numeric(ex_check_db$current_bait_weight_kg)
...
{
   fig <- fig %>% add_trace(x = ex_check_db$days[ex_check_db$replicate==tmp[i]], y=ex_check_db$current_bait_weight_kg[ex_check_db$replicate==tmp[i]],
...
ex_check_db$percentage_weight <- round(ex_check_db$current_bait_weight_kg/as.numeric(ex_check_db$initial_bait_weight_kg),2)*100
