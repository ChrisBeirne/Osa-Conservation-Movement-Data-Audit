...
ex_check_db <- read_excel("data/exc_database.xlsx", sheet="INV_EXCL_DATA", col_types = c("text","text","text", "text","date",                   "text","text","text","text","text","text","text","text","text","text",                   "text","text","text","text","text","text","text","text","text","text", "text","text","text","text","text","text","text","text"))

ex_check_db$visit_date <- dmy(ex_check_db$visit_date)
ex_check_db$deployment_date <- dmy(ex_check_db$deployment_date)
...
ex_locs <- read_excel("data/exc_database.xlsx", sheet="SITES_&_SOIL")
...
Check there is only one treatment per ID:
```{r}
table(ex_check_db$location, paste(ex_check_db$habitat_type, ex_check_db$treatment))
